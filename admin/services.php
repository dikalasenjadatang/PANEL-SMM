...
?>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h3 class="card-title"><i class="fa fa-list"></i> Daftar Layanan</h3>
									</div>
									<div class="card-body">
										<div class="col-md-12">
											<?php 
										...
										<div class="col-md-6">
											<a href="<?php echo $cfg_baseurl; ?>admin/service/add.php" class="btn btn-info"><i class="fa fa-plus"></i> Tambah</a>
										</div>
										<div class="col-md-6">
											<form method="GET">
											<div class="input-group m-b-20">
												<input type="text" name="search" class="form-control input-sm" placeholder="Cari nama layanan">
