									...
									<div class="col-sm-12 padder-v b-r b-light lt">
										...
										<a class="clear" href="#">
											<span class="h3 block m-t-xs">
												<strong>Rp <?php echo number_format($data_wuser['total'],0,',','.'); ?> (Dari <?php echo number_format($count_wuser,0,',','.'); ?> pengguna)</strong>
											</span>
											<small class="text-muted text-uc">Total Saldo Seluruh Pengguna</small>
										</a>
									</div>
								</section>	
									...
									<div class="card-body">
										...
										<div class="col-md-6">
											...
											<div class="input-group m-b-20">
												<input type="text" name="search" class="form-control input-sm" placeholder="Cari username">
