...
?>
			  ...
			  <h2>Tolak Permintaan Deposit</h2>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="<?php echo $cfg_baseurl; ?>"><?php echo $cfg_webname; ?></a></li>
					<li class="breadcrumb-item active">Tolak Permintaan Deposit</li>
				</ol>
			</div>
                        ...
                        <div class="card-block">
										...
										<form class="form-horizontal" role="form" method="POST" action="<?php echo $cfg_baseurl; ?>admin/deposits.php">
											...
											<div class="pull-right">
												<button type="submit" class="btn btn-success btn-bordered waves-effect w-md waves-light" name="cancel">Submit</button>
											</div>
										</form>
									</div>
								</div>
