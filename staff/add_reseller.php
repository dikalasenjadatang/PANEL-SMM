	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['add'])) {
			...
			if (empty($post_username) || empty($post_password)) {
				...
				$insert_user = mysqli_query($db, "INSERT INTO users (username, password, balance, level, registered, status, api_key, uplink) VALUES ('$post_username', '$post_password', '$post_balance', 'Reseller', '$date', 'Active', '$post_api', '$sess_username')");
				if ($insert_user == TRUE) {
					$msg_type = "success";
					$msg_content = "<h>Selamat</h> Reseller telah ditambahkan.<br /> Di <b>REDIR-PEDIA</b> Gunakan Dengan Bijak! <br /><b>Username:</b> $post_username<br /><b>Password:</b> $post_password<br /><b>Level:</b> Reseller<br /><b>Saldo:</b> Rp ".number_format($post_balance,0,',','.');
				} else {
					$msg_type = "error";
                ...
                <div class="content">
                    <div class="container-fluid">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h3 class="card-title"><i class="fa fa-plus"></i> Tambah Reseller</h3>
									</div>
									<div class="card-body">
										<?php 
										if ($msg_type == "success") {
										...
										<form class="form-horizontal" role="form" method="POST">
											<div class="alert alert-info">
												- Saldo Anda terpotong Rp <?php echo number_format($post_price,0,',','.'); ?> untuk pendaftaran 1 Reseller.<br />
												- Reseller baru akan mendapat saldo Rp. <?php echo number_format($post_balance,0,',','.'); ?>.
											</div>
