	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['add'])) {
			...
			if (empty($post_username) || empty($post_password)) {
				...
				if ($insert_user == TRUE) {
					$msg_type = "success";
					$msg_content = "<h>Selamat</h> Agen telah ditambahkan.<br /> Di <b>REDIR-PEDIA</b> Gunakan Dengan Bijak! <br /><b>Username:</b> $post_username<br /><b>Password:</b> $post_password<br /><b>Level:</b> Agen<br /><b>Saldo:</b> Rp ".number_format($post_balance,0,',','.');
				} else {
					$msg_type = "error";
                ...
                <div class="content">
                    <div class="container-fluid">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h3 class="card-title"><i class="fa fa-plus"></i> Tambah Agen</h3>
									</div>
									<div class="card-body">
										<?php 
										if ($msg_type == "success") {
										...
										<form class="form-horizontal" role="form" method="POST">
											<div class="alert alert-info">
												- Saldo Anda terpotong Rp <?php echo number_format($post_price,0,',','.'); ?> untuk pendaftaran 1 Agen.<br />
												- Agen baru akan mendapat saldo Rp. <?php echo number_format($post_balance,0,',','.'); ?>.
											</div>
